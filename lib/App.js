...
class App {
    ...
    //Call inquirer to prompt user to select a role and fill out information about that role. If exit is chosen, the HTML gets rendered.
    // Else a new employee is created and pushed to the array of employees. Calls to start from the beginning.
    nextEmployee() {
